            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="px-4 py-2"><FontAwesomeIcon icon={faSliders} className="pr-3"/> All Category</div>
                        ...
                        <div className="px-4 py-2 border-t border-gray-200"><FontAwesomeIcon icon={faBox} className="pr-3"/> My Orders</div>
                        <div className="px-4 py-2"><FontAwesomeIcon icon={faGift} className="pr-3"/> My Coupon</div>
                        <div className="px-4 py-2"><FontAwesomeIcon icon={faHeart} className="pr-3"/> My Wishlist</div>
                        <div className="px-4 py-2"><FontAwesomeIcon icon={faUser} className="pr-3"/> My Account</div>
